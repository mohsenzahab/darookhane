...
import 'jalali_calendar_date_picker.dart';
...
/// push [JalaliDatePickerDialog] when the button is tapped.
///
/// ```dart
...
/// See also:
///
///  * [showJalaliDateRangePicker], which shows a material design date range picker
///    used to select a range of dates.
///  * [calendarPicker.CalendarDatePicker], which provides the calendar grid used by the date picker dialog.
...
Future<DateTime?> showJalaliDatePicker({
  ...
  Widget dialog = JalaliDatePickerDialog(
...
///
/// It is used internally by [showJalaliDatePicker] or can be directly pushed
/// onto the [Navigator] stack to enable state restoration. See
/// [showJalaliDatePicker] for a state restoration app example.
///
/// See also:
///
///  * [showJalaliDatePicker], which is a way to display the date picker.
class JalaliDatePickerDialog extends StatefulWidget {
  ...
  /// Restoration ID to save and restore the state of the [JalaliDatePickerDialog].
  ///
...
class _JalaliDatePickerDialogState extends State<JalaliDatePickerDialog>
  ...
  Widget build(BuildContext context) {
    ...
    final String dateText = JalaliDateUtils.formatMediumDate(
        _selectedDate.value,
    ...
    JalaliCalendarDatePicker calendarDatePicker() {
      return JalaliCalendarDatePicker(
...
/// This is accomplished by enabling state restoration by specifying
/// [MaterialApp.restorationScopeId] and using [Navigator.restorablePush] to
/// push [JalaliDateRangePickerDialog] when the button is tapped.
///
/// ```dart
...
/// See also:
///
///  * [showJalaliDatePicker], which shows a material design date picker used to
///    select a single date.
///  * [DateTimeRange], which is used to describe a date range.
///
Future<DateTimeRange?> showJalaliDateRangePicker({
  required BuildContext context,
  ...
  Widget dialog = JalaliDateRangePickerDialog(
...
///
/// It is used internally by [showJalaliDateRangePicker] or can be directly pushed
/// onto the [Navigator] stack to enable state restoration. See
/// [showJalaliDateRangePicker] for a state restoration app example.
///
/// See also:
///
///  * [showJalaliDateRangePicker], which is a way to display the date picker.
class JalaliDateRangePickerDialog extends StatefulWidget {
  /// A Material-style date range picker dialog.
  const JalaliDateRangePickerDialog({
    Key? key,
  ...
  /// Restoration ID to save and restore the state of the [JalaliDateRangePickerDialog].
  ///
  ...
  @override
  State<JalaliDateRangePickerDialog> createState() =>
      _JalaliDateRangePickerDialogState();
}

class _JalaliDateRangePickerDialogState
    extends State<JalaliDateRangePickerDialog> with RestorationMixin {
  late final _RestorableDatePickerEntryMode _entryMode =
      _RestorableDatePickerEntryMode(widget.initialEntryMode);
